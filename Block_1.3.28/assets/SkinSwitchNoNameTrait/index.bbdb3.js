...
SkinSwitchNoNameTrait: [ function(t, e, r) {
"use strict";
cc._RF.push(e, "95dc4C7fVNLsI+9ytUPudC7", "SkinSwitchNoNameTrait");
...
r.SkinSwitchNoNameTrait = void 0;
var c = function(t) {
i(e, t);
function e() {
...
if (hs.tp.isSkinListScriptsGetItemHeight(t)) {
t.returnValue = 385;
t.replace = !0;
t.returnState = !0;
}
if (hs.tp.isSkinUpItemScrptsGetIsNoname(t)) {
t.returnValue = !0;
t.replace = !0;
t.returnState = !0;
}
};
return o([ classId("SkinSwitchNoNameTrait") ], e);
}(Trait);
r.SkinSwitchNoNameTrait = c;
cc._RF.pop();
}, {} ]
}, {}, [ "SkinSwitchNoNameTrait" ]);
