...
| 想做什么 | 看哪份 |
|---|---|
| 查数值结论（发牌算法、决策链、权重、章节 A/B、Trait 包） | [数值设计报告.md](../../结论/Block_1.3.28/数值设计报告.md) |
...
| 目录 | 内容 |
|---|---|
| [数值设计报告.md](../../结论/Block_1.3.28/数值设计报告.md) | **先读这个**。508 种发牌算法名册、三层发牌决策链、发牌权重 17 档、兴趣曲线低谷触发、章节三套 A/B、皮肤 8 种解锁口径、290 个 Trait 包与单向门、13 个小游戏矩阵 |
