...
| 想做什么 | 看哪份 |
|---|---|
| 查数值结论（曲线、经济、掉率、权重） | [数值设计报告.md](../../结论/Balatro_1.0.1o/数值设计报告.md) |
| 看玩法设计怎么搭起来的（结构、张力、流派、元进程） | [肉鸽玩法设计分析.md](../../结论/Balatro_1.0.1o/肉鸽玩法设计分析.md) |
| 查某个 Boss 盲注做什么、压哪些流派、怎么绕 | [Boss盲注专题.md](../../结论/Balatro_1.0.1o/Boss盲注专题.md) |
| 查出牌之后按什么顺序结算（小丑顺序、乘区、重复触发） | [出牌结算管线.md](../../结论/Balatro_1.0.1o/出牌结算管线.md) |
| 查 20 个挑战各改了什么规则、怎么解锁 | [挑战模式.md](../../结论/Balatro_1.0.1o/挑战模式.md) |
