...
func get_args() -> Array:
	...
	return [str(current_burning_data.chance * 100), str(current_burning_data.damage), str(current_burning_data.duration), Utils.get_scaling_stat_text("stat_elemental_damage")]
